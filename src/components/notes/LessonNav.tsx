...
/**
 * Điều hướng cuối bài. Lý do nó tồn tại: khi bài học là một lộ trình, hành động tiếp
 * theo của người đọc gần như luôn là "bài sau" — bắt họ quay lại trang công nghệ để
 * tìm lại vị trí mình đang ở là một bước thừa.
 */
export function LessonNav({
  ...
  return (
    <nav aria-label="Điều hướng bài học" className="mt-10 border-t pt-6">
      {index >= 0 && total > 0 && (
